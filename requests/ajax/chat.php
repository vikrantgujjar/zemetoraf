    ...
    function send_message() {
        ...
        if ( isGenderFree(self::ActiveUser()->gender) === false ) {
            if (self::ActiveUser()->is_pro == '0') {
                ...
                if (GetNonProMaxUserChatsPerDay(self::ActiveUser()->id) >= $config->not_pro_chat_limit_daily) {
                    if (isHadChatBefore(self::ActiveUser()->id, (int)$to) === false) {
