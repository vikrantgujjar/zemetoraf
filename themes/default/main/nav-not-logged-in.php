            ...
            <ul class="right">
                ...
                <div class="show_mobi_login">
                    ...
                    <ul id="log_in_dropdown" class="dropdown-content">
                        <li><a href="<?php echo $site_url;?>/login" data-ajax="/login" class="btn-flat waves-effect text-main qdt_hdr_auth_btns"><?php echo __( 'Login' );?></a></li>
                        <?php if ($config->user_registration == 1) { ?>
							<li><a href="<?php echo $site_url;?>/register" data-ajax="/register" class="btn-flat btn btn_primary waves-effect waves-light white-text qdt_hdr_auth_btns"><?php echo __( 'Register' );?></a></li>
						<?php } ?>
                    </ul>
                </div>
            </ul>
