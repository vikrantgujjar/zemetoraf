<div class="dt_notifs <?php if($notification->seen == 0 ){ echo 'noti_not_seen'; }else{ echo ''; }?>">
    <a href="javascript:void(0);" data-ajax="<?php echo $notification->url;?>" class="valign-wrapper">
        ...
        <div class="n_detail">
            <p>
                <?php if( !in_array( $notification->type ,array('approve_receipt','disapprove_receipt','coinpayments_canceled','coinpayments_approved') ) ) {?><b <?php echo $style;?>><?php echo $username;?></b><br><?php }?>
