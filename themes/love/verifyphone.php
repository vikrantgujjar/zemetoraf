			...
			<div class="dt_login_con">
				<div class="row dt_login">
					<form method="POST" action="/Useractions/verifyphone" class="login">
						<p><span class="bold"><?php echo __( 'Phone Verification Needed' );?></span></p>
						<div class="alert alert-success" role="alert" style="display:none;"></div>
						<div class="alert alert-danger" role="alert" style="display:none;"></div>
						<div class="row">
							<div class="input-field">
								<input id="mobile" type="tel" name="phone" value="<?php echo (substr($profile->phone_number,1) !== '+') ? '+' . $profile->phone_number : $profile->phone_number;?>">
								<input type="hidden" name="mode" value="phone">
								<label for="email"><?php echo __( 'Phone' );?></label>
							</div>
						</div>
