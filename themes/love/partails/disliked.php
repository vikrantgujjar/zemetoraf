<?php global $site_url;?>
<div class="col l3 m6 s12 matches visit" data-disliked-uid="<?php echo $row->id?>">
    <div class="card valign-wrapper">
        ...
        <div class="card-content">
			...
			<p><?php echo $row->country_txt?></p>
            <div class="rand_bottom_bar">
                <?php if( (int)$row->id !== (int)auth()->id ){ ?>
                <button id="like_btn" class="btn waves-effect like" data-ajax-post="/useractions/remove_dislike" data-ajax-params="userid=<?php echo $row->id?>" data-ajax-callback="callback_disliked_remove_dislike">
