			...
			<div class="col s12">
				<form method="POST" action="/profile/delete_account" class="dt_settings_bg_wrap">
					...
					<div class="delete_acc">
						<div class="alert alert-danger"><?php echo __( 'Are you sure you want to delete your account? All content including published photos and other data will be permanetly removed!' );?></div>
					</div>
					<div class="row">
